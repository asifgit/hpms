...
<html>
	<head>
		<title>HMS:Pharmacist Update settings</title>
				...
				<div class="container">
					...
					<div class="nav-collapse navbar-inverse-collapse collapse">
						<ul class="nav" id="ulInNav">
							...
							<li><a href="lgdinPhUpdtst.php" onclick="return false;" id="clkdMnu">Update settings</a></li>
						</ul>
			...
			<div class="row-fluid" id="InUpdate">
				<div class="span10 offset1" id="InUpdateHdr">
					<div>
						...
						$pwOLDMine	=	mysqli_query($con, "SELECT UPwd FROM hmsaaausers WHERE UID='4'");
							...
							<form name="ChangPW" method="POST" action="myFooter_homeBody/updatePW.php" class="form-horizontal">
								<div class="row-fluid">
									<div class="span7">
										...
										<input type="hidden" name="diRuser" value="4">
									</div>
