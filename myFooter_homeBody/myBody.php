			...
			<div class='row-fluid' id='imgsldshw'>
				...
				<div class='span7' id='imgIntrCnt'>
					<div class='' id='stlrghtToImgz'>
						<h3 class='hdngInCntr'>Introduction:</h3>
						<p>Multan Tariq dawa khana was basically established in 1998 as a productive project to help the needy as well as the patients who have diseases to be cured from someone who is special for them.</p>
					</div>
				</div>
			</div>
			<br>
