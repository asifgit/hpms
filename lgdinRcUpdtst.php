...
<html>
	<head>
		<title>HMS:Receptionist Update settings</title>
				...
				<div class="container">
					...
					<div class="nav-collapse navbar-inverse-collapse collapse">
						<ul class="nav" id="ulInNav">
							...
							<li class="dropdown">
								<a href="lgdinRcViews.php" class="dropdown-toggle" data-toggle="dropdown">View
									<b class="caret"></b>
								</a>
							...
							<li><a href="lgdinRcUpdtst.php" onclick="return false;" id="clkdMnu">Update settings</a></li>
						</ul>
			...
			<div class="row-fluid" id="InUpdate">
				<div class="span10 offset1" id="InUpdateHdr">
					<div>
						...
						<?php
						include('myFooter_homeBody/cnct.php');
						$pwOLDMine	=	mysqli_query($con, "SELECT UPwd FROM hmsaaausers WHERE UID='2'");
							...
							<form name="ChangPW" method="POST" action="myFooter_homeBody/updatePW.php" class="form-horizontal">
								<div class="row-fluid">
									<div class="span7">
										...
										<input type="hidden" name="diRuser" value="2">
									</div>
